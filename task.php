...
// foreach($display_task_info as $task_info) {
    ...
    echo "<a href='process_delete_task.php?task_id=" . $display_task_info['task_id'] . "' style='color:red;'>" . "Delete" . "</a>";
    echo "<a href='process_edit_task.php?task_id=" . $display_task_info['task_id'] . "' style='color:blue;'>" . "Edit" . "</a>";        
    echo "</div>";
    echo "</div>";
